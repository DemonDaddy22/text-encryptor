...
const Select = (props) => {
  ...
  return (
    <Downshift
      ...
      itemToString={(validOptions) =>
        validOptions ? validOptions.name.toString() : ""
      }
    >
      {({
        isOpen,
        ...
        <div className={classes.selectContainer}>
          ...
          {isOpen ? (
            <div className={classes.selectListContainer} {...getMenuProps()}>
